...
import { globalFlags } from "@/utils/GlobalVariables";

let cashbackProcessed = false; // Add this variable outside the component
let balanceDeductOfUser = false; // Add this variable outside the component
let addRewardinTable = false;
...
const OrderPage = async ({
  ...
  if (searchParams?.orderid && searchParams?.price && lineItems) {
  ...
  // console.log("Specific Order Id  ---> ", specificOrderId);
  ...
  // If Complete Order is undefined,
  ...
  // these Conditions will only work. When Complete Order is Defined.
  ...
  if (searchParams?.validCode && !addRewardinTable) {
    ...
    // globalFlags.addRewardinTable = true;
  }
  ...
  if (
    ...
    // globalFlags.balanceDeductOfUser = true;
  } else {
    await checkFirstPurchase();
  }
  ...
  if (
    ...
    balanceDeductOfUser = true;
    // globalFlags.cashbackProcessed = true;
    // globalFlags.balanceDeductOfUser = true;
  }
