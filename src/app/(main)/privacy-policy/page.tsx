...
export default function Privacy() {
  return (
    <main className="max-w-[1150px] px-5 mx-auto mt-6">
      <section className="text-grey-800 py-5">
        <div className="">
          <div className="text-center mb-3 pt-4">
            <div className="mx-auto">
              <h1 className="font-bold mb-3 text-3xl md:text-[40px]">
                WOWCell LTD Privacy Policy
              </h1>
              <p className="w-full md:max-w-[75%] mx-auto text-gray-800">
                This privacy policy will explain how our organization uses the
                personal data we collect from you when you use esimwe.com
                website or eSIMWe mobile app.
              </p>
            </div>
          </div>
          <div>
            <div>
              ...
              <p className="font-bold my-5">
                <span className="">What data do we collect?</span>
              </p>
              <p className="mb-7">
                <span className="">
                  WOWCell LTD collects the following data:
                </span>
              </p>
              ...
              <p className="font-bold my-5">
                <span className="">How do we collect your data?</span>
              </p>
              <p className="mb-5">
                <span className="">
              ...
              <p className="my-5">
                <span className="">
                  eSIMWe may also receive your data indirectly from the
                  following sources:
                </span>
              </p>
              <ul className="pl-10 list-disc">
                <li className="">
                  <span className="">
                    Google Firebase, Facebook (if you create account with one of
                    these methods)
                  </span>
                </li>
              </ul>
              <p className="font-bold my-5">
                <span className="">How will we use your data?</span>
              </p>
              <p className="mb-5">
                <span className="">
                  eSIMWe collects your data so that we can:
                </span>
              </p>
              <ul className="pl-10 list-disc">
                <li className="">
                ...
                <li className="c12 li-bullet-0">
                  <span className="">
                    In order to get feedback and provide support, eSIMWe
              ...
              <p className="my-5">
                <span className="">
                  If you agree, eSIMWe will share your data with our partner
              ...
              <p className="my-5">
                <span className="">
                  When eSIMWe processes your order, it may send your data
                  to, and also use the resulting information from, credit
                  reference agencies to prevent fraudulent purchases.
                </span>
              </p>
              <p className="font-bold my-5">
                <span className="">How do we store your data?</span>
              </p>
              <p className="mb-5">
                <span className="">
                  eSIMWe securely stores your data at servers belonging to
              ...
              <p className="mb-5">
                <span className="">
                  eSIMWe will store your account, profile, order history,
                  and similar data it has obtained from you until you choose to
                  delete it anytime.
                </span>
              </p>
              <p className="mb-5">
                <span className="">
                  ...
                  in order to comply with any lawful inquiry that may come from
              ...
              <p className="mb-5">
                <span className="">
                  eSIMWe would like to send you information about products
                  and services of ours that we think you might like. If you have
                  agreed to receive marketing, you may always opt out at a later
                  date.
                </span>
              </p>
              <p className="mb-5">
                <span className="">
                  You have the right at any time to stop eSIMWe from
                ...
                <span className="">
                  <a
                    ...
                    href="mailto:support@esimwe.com"
                  >
                    support@esimwe.com
                  </a>
                </span>
                <span className="">
                  &nbsp;with your request, which will be actioned upon within a
                  period of 5 Working days.
                </span>
              </p>
              <p className="font-bold my-5">
                <span className="">What are your data protection rights?</span>
              </p>
              <p className="mb-5">
                <span className="">
                  eSIMWe would like to make sure you are fully aware of all
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to request eSIMWe for copies of
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to request that eSIMWe correct
                  any information you believe is inaccurate. You also have the
                  right to request eSIMWe to complete the information you
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to request that eSIMWe erase
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to request that eSIMWe restrict
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to object to eSIMWe&apos;s
              ...
              <p className="mb-5">
                ...
                <span className="">
                  &nbsp;- You have the right to request that eSIMWe transfer
              ...
              <p className="mb-5">
                <span className="">
                  ...
                  us at our email: support@esimwe.com
                </span>
              </p>
              <p className="font-bold my-5">
              ...
              <p className="font-bold my-5">
                <span className="">How do we use cookies?</span>
              </p>
              <p className="mb-5">
                <span className="">
                  eSIMWe uses cookies in a range of ways to improve your
                  experience on our website, including:
                </span>
              </p>
              <ul className="pl-10 list-disc">
                <li className="">
                  <span className="">Keeping you signed in</span>
                </li>
                <li className="">
                  <span className="">
              ...
              <p className="font-bold my-5">
                <span className="">What types of cookies do we use?</span>
              </p>
              <p className="mb-5">
                <span className="">
              ...
              <ul className="pl-10 list-disc">
                <li className="">
                  <span className="">
                    Functionality - eSIMWe uses these cookies so that we
                ...
                <li className="">
                  <span className="">
                    Targeting / Advertising – eSIMWe uses these cookies to
                    collect information about your visit to our website, the
                    content you viewed, the links you followed and information
                    about your browser, device, and your IP address. eSIMWe
                    sometimes shares some limited aspects of this data with
                    third parties for advertising purposes. We may also share
                    online data collected through cookies with our advertising
                    partners. This means that when you visit another website,
                    you may be shown advertising based on your browsing patterns
                    on our website.
                  </span>
                </li>
                <li className="c12 li-bullet-0">
                  <span className="">
                    Analytics – eSIMWe uses these cookies to improve its
              ...
              <p className="font-bold my-5">
                <span className="">How to manage cookies</span>
              </p>
              <p className="mb-5">
                <span className="">
              ...
              <p className="mb-5">
                <span className="">
                  You can opt-out of advertising and analytics cookies when you
                  first visit our website, or later on by deleting all cookies
                  for esimwe.com, then clicking on &quot;manage
                  preferences&qout; on the cookie prompt.
                </span>
              </p>
              <p className="font-bold my-5">
                <span className="">Privacy policies of other websites</span>
              </p>
              <p className="mb-5">
                <span className="">
                  The esimwe.com website contains links to other websites.
              ...
              <p className="font-bold my-5">
                <span className="">Changes to our privacy policy</span>
              </p>
              <p className="mb-5">
                <span className="">
                  eSIMWe keeps its privacy policy under regular review and
                  places any updates on this web page. This privacy policy was
                  last updated on 07 February 2024.
                </span>
              </p>
              <p className="font-bold my-5">
                <span className="">How to contact us</span>
              </p>
              <p className="mb-5">
                <span className="">
                  ...
                  contact us by email at info@esimwe.com.
                </span>
              </p>
              <p className="">
                <span className="" />
